...
@ReactModule(name = CoreNativeModule.NAME)
class CoreNativeModule(reactContext: ReactApplicationContext) :
  NativeCoreNativeSpec(reactContext) {
  ...
  companion object {
    const val NAME = "CoreNative"

    init {
      System.loadLibrary("cyberathlete-core-native")
    }
  }
}