...
import installer from './NativeCoreNative';
...
export * from './generated/cyberathlete_core_ffi';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as cyberathlete_core_ffi from './generated/cyberathlete_core_ffi';
...
if (!initialized) {
  cyberathlete_core_ffi.default.initialize();
  initialized = true;
}
