...
| 3 | [011 Design system](011-design-system.md) | L | **Before any feature UI.** Task 004 builds the set row — the most important component in the app — and it should be built from a system, not retrofitted into one |
